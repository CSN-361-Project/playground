...
const statusCode SERVER_CREATE_SUCCESS = 1;
const statusCode SERVER_LISTENER_OPEN_FAILED = -1;
const statusCode SERVER_LISTENER_READY = 2;
const statusCode SERVER_LISTENING = 3;
